...
class CodeGenerator(NodeVisitor):
    ...
    def visit_Template(self, node, frame=None):
        ...
        self.writeline('from bd.storage._vendor.jinja2.runtime import ' + ', '.join(exported))

        if self.environment.is_async:
            self.writeline('from bd.storage._vendor.jinja2.asyncsupport import auto_await, '
