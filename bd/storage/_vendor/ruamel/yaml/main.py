...
from . import resolver, emitter, representer, parser, composer, constructor, serializer, \
    scanner, reader, loader, dumper
...
class YAML(object):
    def __init__(
        ...
        if 'rt' in self.typ:
            ...
            self.Emitter = (
                emitter.Emitter if pure or CEmitter is None else CEmitter
            )
